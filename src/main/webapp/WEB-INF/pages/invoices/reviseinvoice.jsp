...
<script type="text/javascript"
	src="<c:url value="/js/modules/transactions/reviseinvoice.js"/>"></script>
...
<div class="box box-info">
	...
	<div class="box-body">
		...
		<form:form class="form-horizontal" action="reviseInvoice">
				...
				<div class="col-md-6">
					...
					<div class="col-md-6">
						<div class='input-group'>
							<input type="hidden" id="invoice-pk" name="invoiceId"> <input
								type='text' class="form-control pull-right" id="inv-number"
								required readonly />
							<div class="input-group-addon">
								<span class="glyphicon glyphicon-chevron-down"
									id="btn-show-invoice" style="cursor: pointer"></span>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="form-group form-required">
				<div class="col-md-6">
					...
					<div class="col-md-6">
						<select class="form-control" id="rev-type" name="revisionType"
							required>
					...
					<div class="col-md-6">
						<div class='input-group date datepicker-input' id="inv-date-grp">
							<input type='text' class="form-control pull-right"
								name="effectiveDate" id="eff-date" required />
							<div class="input-group-addon">
		...
		<div id="existing-invoices">
		<h3>Existing unfinished transactions</h3>
		<hr>
		<table id="invtrans" class="table table-hover table-bordered">
			<thead>
				<tr>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="invoiceModalLabel">Select an
					Invoice</h4>
			</div>
