...
<div class="box box-info" id="acct_model">
	...
	<div class="box-footer">
		<a href="<c:url value='/protected/transactions/invoices/invlist'/> "
		...
		<input type="button" id="auth-btn" class="btn btn-info pull-right"
			style="margin-right: 10px;" value="Authorize"> <input
			type="button" data-toggle="modal" data-target="#reportsModal"
	...
	<div class="box-body">
		<form id="invoice-form" class="form-horizontal">
			...
			<input type="hidden" name="revisionNumber" id="rev-no"> <input
				type="hidden" name="transType" id="trans-type"> <input
				type="hidden" name="invoiceId" id="invoice-pk"> <input
				type="hidden" name="prevInvoice" id="prev-invoice">
			<div class="form-group form-required">
					...
					<div class="col-md-6">
						<div class='input-group date datepicker-input' id="inv-date-grp">
							<input type='text' class="form-control pull-right"
								name="invoiceDate" id="inv-date" required />
				...
				<div class="col-md-6">
					...
					<div class="col-md-7">
						<select class="form-control" id="pay-freq" name="frequency"
							required>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<label for="brn-id" class="col-md-5 control-label">Unit
						Details</label>

					<div class="col-md-7">
						<input type="text" id="unit-number" class="form-control" readonly>
					</div>
				</div>
					...
					<div class="col-md-7">
						<div id="branch-info">
							<input type="hidden" id="brn-id" name="branchId"
								rv-value="invoice.branch.brnCode" /> <input type="hidden"
								id="trans-brn-name">
					...
					<div class="col-md-6">
						<div id="curr-info-panel">
							<input type="hidden" id="cur-id" name="currCode"
								rv-value="invoice.currency.curCode" /> <input type="hidden"
								id="cur-name">
					...
					<div class="col-md-7">
						<div id="pay-mode-info">
							<input type="hidden" id="pymt-id" name="payId"
								rv-value="invoice.paymentmodes.pmId" /> <input type="hidden"
								id="pymt-desc">
			...
			<div class="form-group">
				<div class="col-md-6">
					<label for="brn-id" class="col-md-6 control-label">Installment
						Amount</label>
				...
				<div class="col-md-6">
					<label for="brn-id" class="col-md-5 control-label">Transaction
						Type</label>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="chargesModalLabel">New Charge</h4>
			</div>
			<div class="modal-body">
				<div id="rates-new-div"></div>
			</div>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<ul style="list-style-type: none;">
							<li><a
								href="<c:url value='/protected/transactions/invoices/invoice_rpt'/> "
								target="_blank">Tenant Debit Note</a></li>
						 	<li><a href="<c:url value='/protected/transactions/invoices/tenant_stmt'/>" target="_blank">Tenant Statement</a></li> 
							<li><button type="button" class="hyperlink-btn" style="text-decoration: none;" id="send-email">Send Debit Note</button></li> 
						</ul>
					</div>
					<div class="col-md-6">
